...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-teal-50 to-blue-50 pb-24">
      ...
      <main className="px-6 space-y-6">
        <div className="space-y-2">
          <h1 className="text-3xl font-heading font-semibold text-gray-800">
        ...
        <Card className="bg-white/60 backdrop-blur-sm border-none shadow-lg rounded-3xl overflow-hidden">
          <CardContent className="p-6 space-y-4">
            <h2 className="text-lg font-heading font-medium text-gray-700">How are you feeling today?</h2>
                ...
                <button
                  ...
                  className={`flex-shrink-0 w-16 h-16 rounded-full flex items-center justify-center text-3xl transition-all ${
                    selectedMood === mood.label
                      ? "bg-gradient-to-br from-teal-300 to-cyan-300 scale-110"
        ...
        <Card className="bg-gradient-to-br from-teal-100 to-cyan-100 border-none shadow-lg rounded-3xl overflow-hidden">
          <CardContent className="p-6 space-y-4">
            <h2 className="text-lg font-heading font-medium text-gray-700">Prompt of the Day</h2>
